...
const fieldStyle = { border: "1px solid #ccc", padding: "10px 12px", fontSize: "13px" }
const labelStyle = { display: "flex", flexDirection: "column" as const, gap: "5px", fontSize: "12px", fontWeight: "bold", color: "#333" }
            ...
            {isOpen && (
                ...
                >
                    <div
                        ...
                        style={{ width: "100%", maxWidth: "620px", backgroundColor: "#fff", borderRadius: "8px", boxShadow: "0 24px 60px rgba(0, 0, 0, 0.18)", overflow: "hidden" }}
                    >
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "16px", padding: "18px 22px", borderBottom: "1px solid #e5e7eb" }}>
                            <div>
                                <h2 id="account-settings-modal-title" style={{ margin: 0, color: "#111827" }}>Account settings</h2>
                                <p style={{ margin: "6px 0 0", color: "#666", fontSize: "13px" }}>Datele contului si schimbarea parolei.</p>
                            </div>
                            <button
                                type="button"
                                onClick={closeModal}
                        ...
                        <form onSubmit={handleSubmit} style={{ padding: "22px", display: "flex", flexDirection: "column", gap: "18px" }}>
                            ...
                            <div style={{ borderTop: "1px solid #e5e7eb", paddingTop: "16px" }}>
                                <h3 style={{ margin: "0 0 12px", fontSize: "15px", color: "#111827" }}>Schimbare Parola</h3>
                                <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: "12px" }}>
                                    <label style={labelStyle}>
                                        Parola noua
                            ...
                            {error && <p style={{ color: "#c00", fontSize: "12px", margin: 0 }}>{error}</p>}
                            {message && <p style={{ color: "#166534", fontSize: "12px", margin: 0 }}>{message}</p>}

                            <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px", paddingTop: "4px" }}>
                                <button type="button" onClick={closeModal} disabled={isPending} style={{ border: "1px solid #ccc", background: "#fff", padding: "9px 18px", cursor: isPending ? "not-allowed" : "pointer" }}>
                                    Anuleaza
                                </button>
